private def downloadJacocoIfNeeded() {
    def jacoURL = 'https://repo1.maven.org/maven2/org/jacoco/jacoco/0.8.7/jacoco-0.8.7.zip'
...
def generateJacocoReport() {
    sh "mvn -Djacoco.dataFile=${WORKSPACE}/jacoco.exec org.jacoco:jacoco-maven-plugin:0.8.7:report"
}

def prepareJacocoAgentSteps() {
    return " -Djacoco.destFile=${WORKSPACE}/jacoco.exec -Djacoco.append=true org.jacoco:jacoco-maven-plugin:0.8.7:prepare-agent "
}
